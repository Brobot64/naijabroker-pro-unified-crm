  ...
  async saveEvaluatedQuotes(quoteId: string, quotes: EvaluatedQuote[]): Promise<{ data: any; error: any }> {
    try {
      ...
      const quotesToInsert = quotes.map(quote => ({
        ...
        commission_split: quote.commission_split,
        terms_conditions: quote.terms_conditions,
        exclusions: quote.exclusions,
        coverage_limits: quote.coverage_limits,
        rating_score: quote.rating_score,
        remarks: quote.remarks,
        document_url: quote.document_url,
        response_received: quote.response_received,
        status: quote.status,
        source: quote.source,
        evaluation_source: quote.evaluation_source,
        ai_analysis: quote.ai_analysis,
        dispatched_at: quote.dispatched_at,
